<?php
/** ---------------------------------------------------------------------
 * support/sql/migrations/VersionUpdate166.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
 ...
 require_once(__CA_MODELS_DIR__.'/ca_locales.php');
	...
	class VersionUpdate166 extends BaseVersionUpdater {
		# -------------------------------------------------------
		protected $opn_schema_update_to_version_number = 166;
		...
		public function getPostupdateMessage() {
			return _t("You must now rebuild search indices <strong>and</strong> sort values using the administrative maintenance options shown below. These options are available under <em>Administrate</em> in the <em>Manage</em> menu.<br/><div class='contentSuccess'>%1</div>", "<img src='".__CA_URL_ROOT__."/support/sql/migrations/166/rebuild.png' width='246' height='276' alt='Maintenance menu'/>");
		}
		# -------------------------------------------------------
	}
?>