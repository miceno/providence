In these directories are contained our (hopefully) ever-expanding array of CA unit tests. All tests are written for use with the PHPUnit (http://www.phpunit.de/) testing framework and should be run with the phpunit command.
